...
quiz = [
    {"pergunta": "Em qual programa Margaret Hamilton esteve envolvida?",
     "opcoes": ["a) Sputnik", "b) Gêmeos", "c) Mercúrio", "d) Apollo", "e) Skylab"], "resposta": "d"},
    {"pergunta": "Em qual filme Margaret Hamilton atuou?",
     "opcoes": ["a) Caça às Bruxas", "b) Titanic", "c) O Mágico de OZ", "d) Avatar", "e) Frozen"], "resposta": "c"},
    {"pergunta": "Em que ano aconteceu a missão Apollo?",
     "opcoes": ["a) 2000", "b) 1969", "c) 1980", "d) 1970", "e) 1950"], "resposta": "b"},
    {"pergunta": "Em que ano Margaret Hamilton recebeu a medalha da liberdade?",
     "opcoes": ["a) 2018", "b) 2017", "c) 2016", "d) 2015", "e) 2020"], "resposta": "c"},
    {"pergunta": "Quantos artigos Margaret Hamilton publicou?",
     "opcoes": ["a) Mais de 10", "b) Mais de 150", "c) Mais de 130", "d) Mais de 50", "e) Mais de 5"], "resposta": "c"},
    {"pergunta": "Qual personagem ela interpretou no Mágico de OZ?",
     "opcoes": ["a) Dorothy", "b) Glinda", "c) Leão", "d) Espantalho", "e) Bruxa Má do Oeste"], "resposta": "e"},
    ...
    {"pergunta": "Em qual ano Margaret Hamilton nasceu?",
     "opcoes": ["a) 1989", "b) 1936", "c) 1990", "d) 1920", "e) 1945"], "resposta": "b"},
    {"pergunta": "Qual é o significado de MIT?",
     "opcoes": ["a) Máquina Inteligente Tecnológica", "b) Ministério Internacional",
               "c) Módulo de Tributos", "d) Instituto de Tecnologia de Massachusetts",
               "e) Método Internacional Técnico"], "resposta": "d"},
    {"pergunta": "Margaret Hamilton foi uma grande cientista da computação.",
     "opcoes": ["a) Falso", "b) Verdadeiro"], "resposta": "b"}
]
